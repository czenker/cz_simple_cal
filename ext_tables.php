...
if(t3lib_extMgm::isLoaded('tt_address')){
	...
	$tempColumns = Array (
	    'tx_cal_controller_islocation' => Array (
	        'exclude' => 1,
	        'label' => 'LLL:EXT:cz_simple_cal/Resources/Private/Language/locallang_db.xml:tt_address.is_location',
	        'config' => Array (
	            'type' => 'check',
	            'default' => 0,
	        )
	...
	$tempColumns = Array (
	    'tx_cal_controller_isorganizer' => Array (
	        'exclude' => 1,
	        'label' => 'LLL:EXT:cz_simple_cal/Resources/Private/Language/locallang_db.xml:tt_address.is_organizer',
	        'config' => Array (
	            'type' => 'check',
	            'default' => 0,
	        )
