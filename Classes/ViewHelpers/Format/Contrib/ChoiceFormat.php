...
/**
 * Tx_CzSimpleCal_Contrib_Choice_Format class file.
 *
...
/**
 * Tx_CzSimpleCal_Contrib_Choice_Format class.
 * 
 * This is a port of symfony's sfChoiceFormat
 * 
 * Tx_CzSimpleCal_Contrib_Choice_Format converts between ranges of numeric values and string 
 * names for those ranges.
 *
 * A Tx_CzSimpleCal_Contrib_Choice_Format splits the real number line -Inf to +Inf into two or 
 * more contiguous ranges. Each range is mapped to a string. 
 * Tx_CzSimpleCal_Contrib_Choice_Format is generally used in a MessageFormat for displaying 
 ...
 *
 *  $choice = new Tx_CzSimpleCal_Contrib_Choice_Format();
 ...
 */
class Tx_CzSimpleCal_ViewHelpers_Format_Contrib_ChoiceFormat
{
  /**
