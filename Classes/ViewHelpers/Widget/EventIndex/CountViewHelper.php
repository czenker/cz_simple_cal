 ...
 */
class Tx_CzSimpleCal_ViewHelpers_Widget_EventIndex_CountViewHelper extends Tx_Fluid_Core_Widget_AbstractWidgetViewHelper {

	/**
	 * @var Tx_CzSimpleCal_ViewHelpers_Widget_EventIndex_Controller_CountController
	 */
	protected $controller;

	/**
	 * @param Tx_CzSimpleCal_ViewHelpers_Widget_EventIndex_Controller_CountController $controller
	 * @return void
	 */
	public function injectController(Tx_CzSimpleCal_ViewHelpers_Widget_EventIndex_Controller_CountController $controller) {
	...
	public function initializeArguments() {
		...
		$this->registerArgument('groupBy', 'string', 'groupBy', false, null);
